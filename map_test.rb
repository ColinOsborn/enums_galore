...
class MapTest < Minitest::Test
  ...
  def test_doubles
    numbers = [1, 2, 3, 4, 5]
    doubles = numbers.map do |numbers|
      numbers * 2
    end
  ...
  def test_squares
    numbers = [1, 2, 3, 4, 5]
    squares = numbers.map do |numbers|
      numbers ** 2
    end
  ...
  def test_normalize_zip_codes
    ...
    # zip_codes = numbers.map do |numbers|
    #   numbers.norm
  ...
  def test_trim_last_letter
    ...
    trimmed = animals.map do |quadriped|
      quadriped.chop
    end
